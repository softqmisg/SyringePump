...
typedef struct
{
	...
	lv_obj_t *MainScreen_imgMenuSyringe;
	lv_obj_t *MainScreen_imgMenuDrug;
	lv_obj_t *MainScreen_imgMenuMode;
	lv_obj_t *MainScreen_imgMenuOCC;
	lv_obj_t *MainScreen_imgMenuKVO;
	lv_obj_t *MainScreen_imgMenuIntInf;
	...
	lv_obj_t *MainScreen_imgMenuRhyInf;
	lv_obj_t *MainScreen_imgMenuNurseCall;
	lv_obj_t *MainScreen_imgMenuBolus;
	lv_obj_t *MainScreen_imgMenuPurge;
	lv_obj_t *MainScreen_imgMenuSetting;
...
LV_IMG_DECLARE(_Syringe_72_100x100);
LV_IMG_DECLARE(_Syringe_72_100x100);
LV_IMG_DECLARE(_Syringe_72_100x100);
LV_IMG_DECLARE(_Syringe_72_100x100);
LV_IMG_DECLARE(_Syringe_72_100x100);
LV_IMG_DECLARE(_Syringe_72_100x100);
LV_IMG_DECLARE(_Nurse_72_100x100);
LV_IMG_DECLARE(_Nurse_72_100x100);
LV_IMG_DECLARE(_droplet_64_100x100);
LV_IMG_DECLARE(_syringe1_128_100x100);
LV_IMG_DECLARE(_Setting_72_100x100);
