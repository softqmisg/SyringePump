...
#define LV_MEM_CUSTOM 0
    ...
    #define LV_MEM_SIZE (100 * 800U)          /*[bytes]*/
...
#define LV_DISP_ROT_MAX_BUF (10*800)
...
#define LV_USE_GPU_SDL 0
    ...
    #define LV_GPU_SDL_LRU_SIZE (800 * 800 * 8)
#endif
 ...
 *  COMPILER SETTINGS
 *====================*/
#define LV_ATTRIBUTE_IMAGE_QSPI __attribute__((section(".ImageFlashSection")))
#define LV_ATTRIBUTE_FONT_QSPI __attribute__((section(".FontFlashSection")))
#define LV_ATTRIBUTE_TEXT_QSPI __attribute__((section(".TextFlashSection")))
...
#define LV_USE_FREETYPE 0
    ...
    #define LV_FREETYPE_CACHE_SIZE (16 * 800)
