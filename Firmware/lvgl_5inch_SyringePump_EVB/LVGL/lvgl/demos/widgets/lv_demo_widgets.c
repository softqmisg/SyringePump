...
#if LV_MEM_CUSTOM == 0 && LV_MEM_SIZE < (38ul * 800ul)
    #error Insufficient memory for lv_demo_widgets. Please set LV_MEM_SIZE to at least 38KB (38ul * 800ul).  48KB is recommended.
#endif
