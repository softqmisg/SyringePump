...
void setup_scr_MainScreen(lv_ui *ui)
{
	...
	lv_style_set_text_font(&style_MainScreen_listSyringeCompany_extra_btns_main_default, &lv_font_montserratMedium_16);
	...
	lv_style_set_text_font(&style_MainScreen_listSyringeCompany_extra_btns_main_focused, &lv_font_montserratMedium_16);
	...
	lv_style_set_text_font(&style_MainScreen_listSyringeType_extra_btns_main_default, &lv_font_montserratMedium_16);
	...
	lv_style_set_text_font(&style_MainScreen_listSyringeType_extra_btns_main_focused, &lv_font_montserratMedium_16);
	...
	#endif
	lv_obj_set_pos(ui->MainScreen_taSyringeNameValue, 79, 0);
	...
	lv_obj_set_style_text_font(ui->MainScreen_taSyringeNameValue, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->MainScreen_spinboxSyringeVolume, &lv_font_montserratMedium_14, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->MainScreen_spinboxSyringeVolume, &lv_font_montserratMedium_14, LV_PART_CURSOR|LV_STATE_DEFAULT);
	...
	lv_style_set_bg_opa(&style_MainScreen_spinboxSyringeVolume_extra_btns_main_default, 255);
	lv_style_set_bg_color(&style_MainScreen_spinboxSyringeVolume_extra_btns_main_default, lv_color_hex(0x2195f6));
	lv_style_set_bg_grad_dir(&style_MainScreen_spinboxSyringeVolume_extra_btns_main_default, LV_GRAD_DIR_NONE);
	...
	lv_obj_set_style_text_font(ui->MainScreen_spinboxSyringeInnerDia, &lv_font_montserratMedium_14, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->MainScreen_spinboxSyringeInnerDia, &lv_font_montserratMedium_14, LV_PART_CURSOR|LV_STATE_DEFAULT);
	...
	lv_style_set_bg_opa(&style_MainScreen_spinboxSyringeInnerDia_extra_btns_main_default, 255);
	lv_style_set_bg_color(&style_MainScreen_spinboxSyringeInnerDia_extra_btns_main_default, lv_color_hex(0x2195f6));
	lv_style_set_bg_grad_dir(&style_MainScreen_spinboxSyringeInnerDia_extra_btns_main_default, LV_GRAD_DIR_NONE);
	...
	lv_obj_set_pos(ui->MainScreen_spinboxSyringeOuterDia, 123, 104);
	...
	lv_obj_set_style_text_font(ui->MainScreen_spinboxSyringeOuterDia, &lv_font_montserratMedium_14, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_style_set_bg_opa(&style_MainScreen_spinboxSyringeOuterDia_extra_btns_main_default, 255);
	lv_style_set_bg_color(&style_MainScreen_spinboxSyringeOuterDia_extra_btns_main_default, lv_color_hex(0x2195f6));
	lv_style_set_bg_grad_dir(&style_MainScreen_spinboxSyringeOuterDia_extra_btns_main_default, LV_GRAD_DIR_NONE);
	...
	lv_spinbox_set_digit_format(ui->MainScreen_spinboxSyringeBarrelLen, 3, 2);
	...
	lv_obj_set_style_text_font(ui->MainScreen_spinboxSyringeBarrelLen, &lv_font_montserratMedium_14, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(ui->MainScreen_spinboxSyringeBarrelLen, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_letter_space(ui->MainScreen_spinboxSyringeBarrelLen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write style state: LV_STATE_DEFAULT for &style_MainScreen_spinboxSyringeBarrelLen_extra_btns_main_default
	static lv_style_t style_MainScreen_spinboxSyringeBarrelLen_extra_btns_main_default;
	ui_init_style(&style_MainScreen_spinboxSyringeBarrelLen_extra_btns_main_default);
	
	lv_style_set_text_color(&style_MainScreen_spinboxSyringeBarrelLen_extra_btns_main_default, lv_color_hex(0x000000));
	lv_style_set_text_font(&style_MainScreen_spinboxSyringeBarrelLen_extra_btns_main_default, &lv_font_montserratMedium_12);
	lv_style_set_text_opa(&style_MainScreen_spinboxSyringeBarrelLen_extra_btns_main_default, 255);
	lv_style_set_bg_opa(&style_MainScreen_spinboxSyringeBarrelLen_extra_btns_main_default, 255);
	lv_style_set_bg_color(&style_MainScreen_spinboxSyringeBarrelLen_extra_btns_main_default, lv_color_hex(0x2195f6));
	lv_style_set_bg_grad_dir(&style_MainScreen_spinboxSyringeBarrelLen_extra_btns_main_default, LV_GRAD_DIR_NONE);
	lv_style_set_border_width(&style_MainScreen_spinboxSyringeBarrelLen_extra_btns_main_default, 0);
	lv_style_set_radius(&style_MainScreen_spinboxSyringeBarrelLen_extra_btns_main_default, 5);
	lv_obj_add_style(ui->MainScreen_spinboxSyringeBarrelLen_btn, &style_MainScreen_spinboxSyringeBarrelLen_extra_btns_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_add_style(ui->MainScreen_spinboxSyringeBarrelLen_btn_minus, &style_MainScreen_spinboxSyringeBarrelLen_extra_btns_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_spinbox_set_digit_format(ui->MainScreen_spinboxSyringePlungerLen, 3, 2);
	lv_spinbox_set_range(ui->MainScreen_spinboxSyringePlungerLen, -999, 999);
	...
	lv_obj_set_style_text_font(ui->MainScreen_spinboxSyringePlungerLen, &lv_font_montserratMedium_15, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(ui->MainScreen_spinboxSyringePlungerLen, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_letter_space(ui->MainScreen_spinboxSyringePlungerLen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write style state: LV_STATE_DEFAULT for &style_MainScreen_spinboxSyringePlungerLen_extra_btns_main_default
	static lv_style_t style_MainScreen_spinboxSyringePlungerLen_extra_btns_main_default;
	ui_init_style(&style_MainScreen_spinboxSyringePlungerLen_extra_btns_main_default);
	
	lv_style_set_text_color(&style_MainScreen_spinboxSyringePlungerLen_extra_btns_main_default, lv_color_hex(0x000000));
	lv_style_set_text_font(&style_MainScreen_spinboxSyringePlungerLen_extra_btns_main_default, &lv_font_montserratMedium_12);
	lv_style_set_text_opa(&style_MainScreen_spinboxSyringePlungerLen_extra_btns_main_default, 255);
	lv_style_set_bg_opa(&style_MainScreen_spinboxSyringePlungerLen_extra_btns_main_default, 255);
	lv_style_set_bg_color(&style_MainScreen_spinboxSyringePlungerLen_extra_btns_main_default, lv_color_hex(0x2195f6));
	lv_style_set_bg_grad_dir(&style_MainScreen_spinboxSyringePlungerLen_extra_btns_main_default, LV_GRAD_DIR_NONE);
	lv_style_set_border_width(&style_MainScreen_spinboxSyringePlungerLen_extra_btns_main_default, 0);
	lv_style_set_radius(&style_MainScreen_spinboxSyringePlungerLen_extra_btns_main_default, 5);
	lv_obj_add_style(ui->MainScreen_spinboxSyringePlungerLen_btn, &style_MainScreen_spinboxSyringePlungerLen_extra_btns_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_add_style(ui->MainScreen_spinboxSyringePlungerLen_btn_minus, &style_MainScreen_spinboxSyringePlungerLen_extra_btns_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->MainScreen_spinboxSyringeDiaTolerance, 570, 70);
	...
	lv_spinbox_set_digit_format(ui->MainScreen_spinboxSyringeDiaTolerance, 3, 2);
	lv_spinbox_set_range(ui->MainScreen_spinboxSyringeDiaTolerance, -999, 999);
	...
	lv_obj_set_style_text_font(ui->MainScreen_spinboxSyringeDiaTolerance, &lv_font_montserratMedium_14, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(ui->MainScreen_spinboxSyringeDiaTolerance, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_letter_space(ui->MainScreen_spinboxSyringeDiaTolerance, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write style state: LV_STATE_DEFAULT for &style_MainScreen_spinboxSyringeDiaTolerance_extra_btns_main_default
	static lv_style_t style_MainScreen_spinboxSyringeDiaTolerance_extra_btns_main_default;
	ui_init_style(&style_MainScreen_spinboxSyringeDiaTolerance_extra_btns_main_default);
	
	lv_style_set_text_color(&style_MainScreen_spinboxSyringeDiaTolerance_extra_btns_main_default, lv_color_hex(0x000000));
	lv_style_set_text_font(&style_MainScreen_spinboxSyringeDiaTolerance_extra_btns_main_default, &lv_font_montserratMedium_12);
	lv_style_set_text_opa(&style_MainScreen_spinboxSyringeDiaTolerance_extra_btns_main_default, 255);
	lv_style_set_bg_opa(&style_MainScreen_spinboxSyringeDiaTolerance_extra_btns_main_default, 255);
	lv_style_set_bg_color(&style_MainScreen_spinboxSyringeDiaTolerance_extra_btns_main_default, lv_color_hex(0x2195f6));
	lv_style_set_bg_grad_dir(&style_MainScreen_spinboxSyringeDiaTolerance_extra_btns_main_default, LV_GRAD_DIR_NONE);
	lv_style_set_border_width(&style_MainScreen_spinboxSyringeDiaTolerance_extra_btns_main_default, 0);
	lv_style_set_radius(&style_MainScreen_spinboxSyringeDiaTolerance_extra_btns_main_default, 5);
	lv_obj_add_style(ui->MainScreen_spinboxSyringeDiaTolerance_btn, &style_MainScreen_spinboxSyringeDiaTolerance_extra_btns_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_add_style(ui->MainScreen_spinboxSyringeDiaTolerance_btn_minus, &style_MainScreen_spinboxSyringeDiaTolerance_extra_btns_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);
